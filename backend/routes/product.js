...
const { getProducts,newProduct,getSingleProcduct,updateProdcut,deleteProduct, createProductReview, getProductReviews, deleteReview } = require('../controllers/productController')
